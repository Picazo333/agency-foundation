...
5. **Technical Foundation / Repo Hardening / Capability Governance / Project Harvest:** reviewed foundation work is integrated in `main`. Legacy execution branches may remain in GitHub for history but are not active workspaces unless explicitly reactivated.
...
Gemini or other generators may later act as asset-generation engines only inside approved Brand/Asset Factory contracts. Antigravity or other environments may be used when a concrete capability advantage justifies them.
...
- Implementation is split into Aesthetic / Functional / System spines.
...
- Brand Direction V0.
- Agency archetype/business model — `ADR-0006` is a working thesis under validation, not a freeze.
- Initial ICP — candidate logic exists; evidence gate still governs.
- Positioning — `ADR-0010` remains proposed.
- Offer architecture and pricing — architecture proposed; prices remain evidence-limited and must follow the governing strategy/validation documents.
- Validation outcomes — instrumentation exists; real-world evidence still governs conclusions.
- Full Brand System V1.
- Production stack and final website architecture.
- Which optional executors/tools materially improve later implementation stages.
